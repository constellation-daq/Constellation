/**
 * @file
 * @brief Telemetry Console main function
 *
...
int main(int argc, char** argv) {
    try {
        ...
        try {
            ...
            QCoreApplication::setApplicationName("TelemetryConsole");
        ...
        auto parser = GUIParser("TelemetryConsole");
        parser.setup();
        ...
        // Set log level
        constellation_setup_logging(options.log_level, "TelemetryConsole");
        ...
        // Start TelemetryConsole
        try {
            TelemetryConsole gui {group_name};
            gui.show();
