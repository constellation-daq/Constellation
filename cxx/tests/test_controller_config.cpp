...
TEST_CASE("Resolving controller-side environment variables in TOML", "[controller]") {
...
TEST_CASE("Resolving controller-side environment variables in YAML", "[controller]") {
    ...
    const auto test_file = test_files_dir() / "env_config.yaml";
    const ControllerConfiguration config {test_file};
