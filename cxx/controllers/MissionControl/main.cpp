/**
 * @file
 * @brief MissionControl main function
 *
...
int main(int argc, char* argv[]) {
    try {
        ...
        auto parser = GUIParser("MissionControl");
        parser.setup();
        ...
        try {
            ...
            LOG(CRITICAL) << "Run `MissionControl --help` for help";
            return 1;
        }
        ...
        const auto controller_name = "MissionControl" + instance_name;

        // Setup CHIRP
        constellation_setup_chirp(group_name, controller_name, options.interfaces);
