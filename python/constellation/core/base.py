...
class BaseSatelliteFrame:
    ...
    def __init__(self, name: str, interface: str, mon_port: int | None, **_kwds: Any):
        ...
        self._cmdp_transmitter = CMDPTransmitter(self.name, self.context, self.interface, mon_port)
        self.mon_port = self._cmdp_transmitter.port
